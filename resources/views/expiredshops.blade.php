            ...
            <div class="col-md-12">
                <div class="custom-panel card py-2">
                    <div class="font-weight-bold text-secondary mb-1 py-3 px-3">
                        Expired shops
                        <h3>Expected amount = <span class="text-danger"> ₦{{ number_format($amount_due) }}</span></h3>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            @else
                                <tr>
                                    <td colspan="7">
                                        <div class="d-flex justify-content-center"> No Unpaid / Expired Shops yet</div>
                                    </td>
                                </tr>
                            @endif
                            </tbody>
